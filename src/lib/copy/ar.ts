...
export const ar: Copy = {
  ...
  cases: {
    eyebrow: 'الحالات',
    headlineTop: 'قبل',
    headlineOutlined: 'وبعد',
    lead:
      'صور من حالات عولجت في العيادة، كما التُقطت على الكرسي وفي المعمل. كل صورة تُسمّي الإجراء، ولا تَعِد أيٌّ منها بنتيجتك أنت — فتلك تُقرَّر في الكشف، من أشعتك الخاصة.',
    compare: {
      label: 'حالة مختارة',
      title: 'عدسات سيراميك للأسنان الأمامية العلوية',
      body:
        'تركيبات قديمة متغيّرة اللون على الأسنان الأمامية العلوية، استُبدلت بعدسات سيراميك. اسحب المقبض عبر الصورة للمقارنة بينهما.',
      before: 'قبل',
      after: 'بعد',
      handleAria: 'قارن بين قبل وبعد',
      hint: 'اسحب للمقارنة',
    },
    filters: {
      all: 'الكل',
      implants: 'الزراعة والفك الكامل',
      restorative: 'التيجان والعدسات',
      lab: 'عمل المعمل',
    },
    filterAria: 'تصفية الحالات',
    items: {
      'full-arch-both': {
        title: 'تركيبات ثابتة للفكين على زرعات',
        note: 'مدعومة بالزرعات · منظر بالمباعد',
      },
      'upper-arch-fixed': {
        title: 'تركيبة ثابتة للفك العلوي كاملًا',
        note: 'مقابل أسنان سفلية طبيعية',
      },
      'upper-arch-closeup': {
        title: 'تركيبة الفك العلوي، تفصيل',
        note: 'شكل اللثة والأسنان',
      },
      'full-mouth-smile': {
        title: 'إعادة تأهيل الفم كاملًا',
        note: 'الابتسامة النهائية · الفكان',
      },
      'smile-portrait': {
        title: 'ترميم الأسنان الأمامية، الابتسامة النهائية',
        note: 'الأسنان الأمامية العلوية',
      },
      'anterior-crowns-retractor': {
        title: 'تيجان سيراميك للأسنان الأمامية العلوية',
        note: 'منظر بالمباعد عند التركيب',
      },
      'anterior-crowns-smile': {
        title: 'تيجان أمامية علوية، منظر الابتسامة',
        note: 'خط الابتسامة عند التركيب',
      },
      'lab-master-cast': {
        title: 'تيجان سيراميك على النموذج الرئيسي',
        note: 'مرحلة المعمل · قبل التركيب',
      },
    },
    open: 'افتح الحالة {n}: {title}',
    close: 'إغلاق',
    ...
    view: 'عرض',
    disclaimer:
      'صور إكلينيكية لمرضى عولجوا في {clinic}. النتائج تختلف من شخص لآخر، وصلاحية أي إجراء تُقرَّر في الكشف.',
    cta: 'ناقش حالتك',
    ctaBlurb: 'أحضر أشعتك أو صورة لأسنانك إلى الكشف، أو أرسلها مسبقًا عبر WhatsApp.',
  },
  ...
  team: {
    ...
    'sara-sameh': {
      name: 'د. سارة سامح',
      role: 'التجميل والفينير',
      title: 'طبيبة تجميل وترميم الأسنان',
      specialty: 'تجميل الأسنان · الفينير',
      credentials: ['تجميل الأسنان', 'الفينير', 'تصميم الابتسامة'],
      scopeLead: 'ما تعالجه {name}',
      scopeVerb: 'من حالات',
      lead:
        'تجميل الأسنان وترميمها — تصميم الابتسامة والفينير والعمل المحافظ الذي يُبقي السنّ الطبيعي طبيعيًا.',
      intro:
        'الابتسامة تُخطَّط قبل أن تُحضَّر. اللون والشكل والتناسب يُتفَق عليها معك أولًا — صور وقياسات ونموذج تجريبي ترينه وتغيّرينه — ويبقى الخيار الذي يُزيل أقل قدر من نسيج السنّ مطروحًا دائمًا.',
      focus: [
        { name: 'الفينير الخزفي', descriptor: 'الشكل واللون والتناسب' },
        { name: 'التجميل بالكومبوزيت', descriptor: 'إعادة تشكيل بدون معمل' },
        { name: 'تصميم الابتسامة', descriptor: 'يُخطَّط ويُعرَض قبل التحضير' },
        { name: 'التيجان والحشوات التعويضية', descriptor: 'ترميم السنّ المكسور أو المتآكل' },
        { name: 'تبييض الأسنان', descriptor: 'في العيادة وبإشراف في المنزل' },
        { name: 'الحشوات التجميلية', descriptor: 'بلون السنّ وبأقل تدخُّل' },
        { name: 'تحديد اللثة', descriptor: 'موازنة الإطار حول الأسنان' },
      ],
      cv: [
        {
          heading: 'الممارسة',
          items: [
            'تجميل الأسنان وترميمها في عيادة Ozea لطب الأسنان، مدينة نصر، القاهرة',
            'الفينير والكومبوزيت وحالات تصميم الابتسامة الكاملة',
            'الترميم المحافظ للأسنان المتآكلة والمكسورة والمتغيّرة اللون',
          ],
        },
        {
          heading: 'كيف تسير الحالة',
          items: [
            'الكشف والصور',
            'الاتفاق على اللون والشكل والتناسب',
            'نموذج تجريبي ترينه قبل التحضير',
            'التركيب والمتابعة',
          ],
        },
        {
          heading: 'المنهج',
          items: [
            'إزالة أقل قدر من نسيج السنّ تسمح به النتيجة',
            'لا تحضير قبل الاتفاق على التصميم كتابةً',
            'نرحّب بالتحويلات والرأي الطبي الثاني',
          ],
        },
      ],
      visualCaption:
        'تحضير الفينير في مقطع — تقليل المينا والحدّ والقشرة بعد تركيبها. رسم توضيحي، ليس صورة مريض وليس نتيجة متوقَّعة.',
    },
    'adham-yehia-zakaria': {
